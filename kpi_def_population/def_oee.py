...
payload={'description': 'The OEE index represents the availability of a work unit, the effectiveness of the work unit, and the quality ratio KPIs integrated in a single indicator',
