...
BEGIN
	...
	--
	record_type_uid_V := (select id from dim_record_type where record_type='subKPI' and record_category='PBT' );
...
--	record_state_V := 'running';
    ...
    --
	stmt := (select kpi_logic from kpi_type where kpi_type_id= 'kpi_id2');
	--
	execute stmt
	into stmt_result
